<x-app-layout>
  ...
  <div class="container px-5 py-4 mx-auto">
    ...
    <button onclick="location.href='{{ route('events.past')}}'" class="flex ml-auto mb-4 text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">過去のイベント</button>
